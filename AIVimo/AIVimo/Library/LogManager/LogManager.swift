...
extension LogManager {
    ...
    class func logMessage(mesage: String, lineNumber:Int = #line, functionName:String = #function) {
        let formattedMessage = "line Numner == \(lineNumber) and Function Name == \(functionName) and Message == \(mesage)"
        debugPrint(formattedMessage)
        NSLogger().log(formattedMessage, properties: nil, error: false)
    }
}
